...
import { Box, Center, Text, VStack, Pressable, ScrollView, HStack, Icon, Button } from 'native-base'
import AsyncStorage from '@react-native-async-storage/async-storage'
import { RefreshControl } from 'react-native'
import { deleteSetAPI, getUserSetsDetailAPI } from '../api/setAPI'
import SwipeView from '../component/swipable-list'
import { Feather } from '@expo/vector-icons'
const SetsLists = ({ navigation }) => {
  ...
  const onPressSet = (setId) => {
     ...
     */
    navigation.navigate('Listvocab', {setId})
  }
